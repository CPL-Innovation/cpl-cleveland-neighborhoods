...
import { Field, FieldGroup, FieldFoot, ChipInput, inputStyle, textareaStyle } from "@/components/staff/ui";
...
export function StaffStoryAuthor() {
...
function StorySubBar() {
  ...
  return (
    <div style={{
      ...
      } as React.CSSProperties}>Draft</span>
      <span style={{
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        } as React.CSSProperties}>Sandbox URL</div>
        <div style={{
...
function FormatSegmented({ value }: { value: string }) {
  const t = STAFF_TOKENS;
  const opts = [
  ...
  return (
    <div style={{
      ...
      {opts.map((o, i) => (
        ...
        } as React.CSSProperties}>{o.label}</div>
      ))}
    </div>
  );
}

function FeaturedSlider({ value }: { value: number }) {
  const t = STAFF_TOKENS;
  return (
    <div>
      <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          letterSpacing: 1.4, textTransform: 'uppercase',
          color: t.inkMuted,
        } as React.CSSProperties}>Sequence · {stops.length} stops · 5.2 mi</div>
...
function SequenceStop({ stop: s, t, isLast }: { stop: Stop; t: StaffTokens; isLast?: boolean }) {
  return (
    <div style={{ position: 'relative', marginBottom: 14 }}>
        ...
        <div style={{ minWidth: 0 }}>
          ...
          {s.comment && (
            <div style={{
              ...
              } as React.CSSProperties}>resolved</span>}
            </div>
          )}
        </div>
      </div>
      ...
      {!isLast && (
        <div style={{
          ...
          } as React.CSSProperties}>Transition</div>
          <input
    ...
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          ...
          letterSpacing: 1.4, textTransform: 'uppercase',
          color: t.inkFaint,
        } as React.CSSProperties}>Preview · as patron</span>
      ...
      <div style={{
        ...
        <div style={{
          ...
          } as React.CSSProperties}>Map trail · 5 stops · 5.2 mi</div>
          <div style={{
            fontFamily: t.serif, fontSize: 18, fontWeight: 500,
            letterSpacing: -0.2, lineHeight: 1.15,
            color: t.ink, marginBottom: 5,
            textWrap: 'pretty',
          } as React.CSSProperties}>Streetcars of Detroit Avenue</div>
          <div style={{
            fontSize: 11, color: t.inkSubtle, lineHeight: 1.4,
            textWrap: 'pretty',
          } as React.CSSProperties}>From horse-drawn cars to the last electric line: forty years of one street's spine.</div>
      ...
      <div style={{ marginTop: 18 }}>
        ...
        } as React.CSSProperties}>Pre-publish checks</div>
...
function DeviceBtn({ icon, active }: { icon: string; active?: boolean }) {
...
function CheckRow({ tone, label }: { tone: string; label: string }) {
  const t = STAFF_TOKENS;
  const map: Record<string, { c: string; glyph: React.ReactNode }> = {
